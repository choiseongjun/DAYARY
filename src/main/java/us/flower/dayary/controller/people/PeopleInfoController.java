...
public class PeopleInfoController {
	...
	public Map<String, Object> MoimDeleteOne(@PathVariable("peopleId") long peopleId, Model model,
	...
	public Map<String, Object> getMyNotiCount(HttpSession session, Model model) {
		...
		// List<Noti> notiList=notiService.getPrivateNoti(peopleId, 1);
		List<Noti> notiList = notiService.getMoreNoti(1, peopleId, 'P');
	...
	/*	*//**
			 ...
			 *//*
				 * @ResponseBody
				 * 
				 * @GetMapping("/getMyNotiList/{pageStart}") public Map<String,Object>
				 * getMyNotiList(HttpSession session,@PathVariable("pageStart")int pageStart) {
				 * //회원 번호를 던져준다. long peopleId = (long) session.getAttribute("peopleId");
				 * 
				 * List<Noti> notiList=notiService.getMoreNoti(pageStart, peopleId, 'P');
				 * Map<String,Object> data=new HashMap<String,Object>();
				 * data.put("notiList",notiList);
				 * 
				 * return data; }
